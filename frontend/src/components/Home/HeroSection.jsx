    ...
    <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-4 flex justify-center order-1 lg:order-2 mb-12 lg:mb-0">
            ...
            <div className="lg:col-span-4 flex justify-center lg:justify-end order-3">
                 <div className="bg-surface p-6 rounded-3xl w-72 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300 border border-primary/10">
                      <div className="h-48 bg-primary/10 rounded-2xl mb-4 relative overflow-hidden flex items-center justify-center">
                      ...
                      <p className="text-primary/70 text-sm mb-6">Keep your mindfulness journey going.</p>
